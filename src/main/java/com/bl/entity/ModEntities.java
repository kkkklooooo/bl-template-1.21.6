...
public class ModEntities {
    ...
    public static final EntityType<ExpandingSphereEntity> EXPANDING_SPHERE = EntityType.Builder.create(ExpandingSphereEntity::new, SpawnGroup.MISC).dimensions(10f, 10f).maxTrackingRange(64).trackingTickInterval(10).build(registryKey3);
