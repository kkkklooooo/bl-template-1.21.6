...
public class ModEntities {
    ...
    public static final EntityType<QuantumEntityy> QUANTUM_ENTITY = EntityType.Builder.<QuantumEntityy>create(QuantumEntityy::new, SpawnGroup.MISC).dimensions(1f, 2f).maxTrackingRange(64).trackingTickInterval(10).build(registryKey);
}
